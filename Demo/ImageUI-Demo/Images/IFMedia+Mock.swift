...
extension IFMedia {
    ...
    private static var localImages: [IFImage] {
        [
    ...
    private static var remoteImages: [IFImage] {
        [
    ...
    private static var memoryImages: [IFImage] {
        [UIImage(named: "photo1")!, UIImage(named: "photo2")!]
            .map { IFImage(original: .image($0)) }
    }
    
    private static var imageAssets: [IFImage] {
    ...
    private static var remoteVideos: [IFVideo] {
        [
    ...
    // MARK: - GIF
    private static var remoteGIF: [IFImage] {
        [
